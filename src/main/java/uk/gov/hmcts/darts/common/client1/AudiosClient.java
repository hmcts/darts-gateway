...
import uk.gov.hmcts.darts.common.client1.component.HttpHeadersInterceptor;
...
public class AudiosClient extends AbstractRestTemplateClient implements AudiosApi {
     ...
     *                      can be found {@link uk.gov.hmcts.darts.common.client1.multipart.StreamingMultipart}
