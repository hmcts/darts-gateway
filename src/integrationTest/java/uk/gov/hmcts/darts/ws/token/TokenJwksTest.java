...
public class TokenJwksTest extends IntegrationBase {
    ...
    public void checkRefreshOfPublicKeys(ContextRegistryClient client) throws Exception {
    ...
    private String runOperationExpectingJwksRefresh(String token, JkwsRefreshableRunnable runnable) throws Exception {
    ...
    interface JkwsRefreshableRunnable {
        String run(String token) throws Exception;
    }
}
