...
import static uk.gov.hmcts.darts.soap.DartsResponseCodeAndMessage.OK;
...
public class DartsEndpoint {
    ...
    public AddDocumentResponse addDocument(@RequestPayload AddDocument addDocument) {
        ...
        try {
            ...
            addDocumentResponse.setReturn(utils.responseMessageFromException(e));
            return addDocumentResponse;
        }
        addDocumentResponse.setReturn(utils.responseMessageFromCodeAndMessage(OK));
    ...
    public AddCaseResponse addCase(@RequestPayload AddCase addCase) {
        ...
        try {
            ...
            addCaseResponse.setReturn(utils.responseMessageFromException(e));
            return addCaseResponse;
        }
        addCaseResponse.setReturn(utils.responseMessageFromCodeAndMessage(OK));
